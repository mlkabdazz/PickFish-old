...
package com.mlkabdazz.pickfish.tracking;
...
import com.mlkabdazz.pickfish.tflite.Classifier.Recognition;
...
//                            : String.format("%.2f", (100 * recognition.detectionConfidence));
    ...
    private void processResults(final List<Recognition> results) {
        ...
        for (final Pair<Float, Recognition> potential : rectsToTrack) {
            ...
            trackedRecognition.detectionConfidence = potential.first == null ? -1f : potential.first;
